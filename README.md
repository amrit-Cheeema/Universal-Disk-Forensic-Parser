That is an ambitious and impressive scope for a resume project. Moving from FAT to NTFS and APFS shows a deep progression from simple linked-list structures to complex B-trees and copy-on-write (CoW) systems.

Since you are targeting Linux, NTFS, and APFS, I’ve rebranded the README to reflect a Multi-FS (Filesystem) Parser.

Universal Disk Forensics Parser (Go)
Status: 🛠️ Currently In Progress (Active Development)
...
🛠️ Current Capabilities (FAT12/16)
